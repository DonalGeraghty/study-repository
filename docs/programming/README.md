...
- [Programming Languages](./languages/README.md) — Java, Kotlin, Python, R, C#/.NET, JavaScript, TypeScript, SQL, and PowerShell.
- [Frameworks and Libraries](./frameworks/README.md) — Spring, React, Flask, Vue, Express, and Shiny, grouped separately from their underlying languages.
