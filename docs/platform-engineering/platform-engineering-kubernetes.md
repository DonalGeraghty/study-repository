...
This example deploys the `hello-docker:1.0` image created in the [Docker guide](./platform-engineering-docker.md). A Kubernetes node must be able to pull or otherwise access the image.
...
- [Technology Stack](../engineering-foundations/engineering-foundations-technology-stack.md)
