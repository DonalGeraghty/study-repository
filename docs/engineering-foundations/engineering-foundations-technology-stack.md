...
Keep browser abstractions expressed as user-facing tasks and reusable components. See [Design Patterns](../software-design/software-design-design-patterns.md) for Page Object guidance.
...
- [Encoding](./engineering-foundations-encoding.md)
- [Encryption](./engineering-foundations-encryption.md)
- [Hashing](./engineering-foundations-hashing.md)
...
- [Docker](../platform-engineering/platform-engineering-docker.md)
- [Kubernetes](../platform-engineering/platform-engineering-kubernetes.md)
