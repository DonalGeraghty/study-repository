...
| [Encryption](./engineering-foundations-encryption.md) | Keep data confidential | Yes, with the correct key | Yes |
| [Hashing](./engineering-foundations-hashing.md) | Create a fixed-size fingerprint | No, by design | No |
