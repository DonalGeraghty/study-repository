...
Begin with the testing guide to understand risk and feedback levels. Study REST APIs as both an application interface and a lower-level testing boundary, then use the tool guides to record how those principles were applied in automation frameworks.
